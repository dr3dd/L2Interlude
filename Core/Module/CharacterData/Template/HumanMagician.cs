...
{
    public abstract class HumanMagician : Human
    {
        private const string BaseClass = "human_magician";
        ...
        protected HumanMagician(IServiceProvider serviceProvider) : base(serviceProvider)
        {
