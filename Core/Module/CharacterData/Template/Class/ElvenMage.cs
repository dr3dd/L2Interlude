...
{
    public class ElvenMage : ElfMagician, ITemplateHandler
    {
        private const byte ClassId = 25;
        private const string ClassKey = "elven_mage";
        ...
        public ElvenMage(IServiceProvider serviceProvider) : base(serviceProvider)
        {
