...
{
    public class DarkMage : DarkElfMagician, ITemplateHandler
    {
        private const byte ClassId = 38;
        private const string ClassKey = "dark_mage";
        ...
        public DarkMage(IServiceProvider serviceProvider) : base(serviceProvider)
        {
