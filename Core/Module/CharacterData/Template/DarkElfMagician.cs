...
{
    public abstract class DarkElfMagician : DarkElf
    {
        private const string BaseClass = "darkelf_magician";
        ...
        private const byte Int = 44;
        private const byte Str = 23;
        private const byte Con = 24;
        private const byte Men = 37;
        private const byte Dex = 23;
        private const byte Wit = 19;
