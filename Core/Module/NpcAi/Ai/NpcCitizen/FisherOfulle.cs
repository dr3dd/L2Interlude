...
public class FisherOfulle : Fisher
{
    public override IList<BuySellList> SellList0 => new List<BuySellList>
    {
        ...
        new("green_lure_average", 20, 0.000000, 0),
        new("violet_lure_average", 20, 0.000000, 0),
        new("yellow_lure_average", 20, 0.000000, 0),
        ...
        new("fishing_potion1", 20, 0.000000, 0)
    };
}